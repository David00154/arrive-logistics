        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-8 col-sm-5 col-4"> <a class="phone-icon mr-45" href="tel:+01-246-357">
                        ...
                        </svg>Phone: +01-246-357 (Any time 24/7)</a>
...
<header class="header sticky-bar header-style-2">
    <div class="container">
        <div class="header-middle">
            <div class="header-logo"><a class="d-flex" href="index.html"><img alt="{{ config('app.name') }}"
                        src=""></a></div>
            <div class="header-contact">
                <div class="box-header-contact-1 mr-30">
                    <div class="icon-contact"> <img alt="{{ config('app.name') }}"
                            src="{{ env('STATIC_ASSET_URL', '') }}/static/imgs/page/homepage3/address.png"></div>
                    <div class="info-contact">65 Allerton Street 901 N Pitt Str, USA</div>
                </div>
                {{-- <div class="box-header-contact-2">
                    <div class="icon-contact"> <img alt="{{config("app.name")}}"
                            src="{{env("STATIC_ASSET_URL", "")}}/static/imgs/page/homepage3/phone.png"></div>
                    <div class="info-contact">65 Allerton Street 901 N Pitt Str, USA</div>
                </div> --}}
            </div>
        </div>
        <div class="main-header">
            <div class="header-left">
                <div class="header-logo d-inline-block d-md-none"><a class="d-flex" href="/"><img
                            alt="{{ config('app.name') }}" src=""></a></div>
                    ...
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li class="has-children">
                                <a href="/our-services">{{ __('Our Services') }}</a>
                                <div class="sub-menu five-col four-col">
                                        ...
                                        <div class="menu-col">
                                            ...
                                            <ul class="megamenu">
                                                @foreach ($solution['megamenu'] as $megamenu)
                                                    <li>
                                                        <a href="/our-services">{{ $megamenu }}</a>
                                                        {{-- <a
                                                            href="/solution/{{ $solution['href'] }}">{{ $megamenu }}</a> --}}
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                ...
                <div class="header-right">
                    {{-- <div class="d-none d-inline-block box-dropdown-cart">
                        <span class="font-lg icon-list icon-account"><span class="font-sm color-grey-900 arrow-down">
                                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewbox="0 0 24 24"
                                    xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="dropdown-account">
                            <ul>
                                <li><a class="font-md" href="/#"><img
                                            src="{{env("STATIC_ASSET_URL", "")}}/static/imgs/template/icons/en.png"
                                            alt="{{config("app.name")}}">
                                        English</a></li>
                                <li><a class="font-md" href="/#"><img
                                            src="{{env("STATIC_ASSET_URL", "")}}/static/imgs/template/icons/fr.png"
                                            alt="{{config("app.name")}}">
                                        French</a></li>
                                <li><a class="font-md" href="/#"><img
                                            src="{{env("STATIC_ASSET_URL", "")}}/static/imgs/template/icons/cn.png"
                                            alt="{{config("app.name")}}">
                                        Chiness</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="d-none d-sm-inline-block">
                        <a class="btn btn-default mr-10 hover-up" href="{{ route('contact-us') }}">Contact Us</a>
                        <a class="btn btn-brand-1 d-none d-xl-inline-block hover-up" href="{{ route('get-quote') }}">
                            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewbox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
