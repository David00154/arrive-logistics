   <form wire:submit='createQuote' class="box-form-contact-leading">
       ...
       {{-- <div class="mt-lg-0 mt-20"></div> --}}
       <div class="col-lg-8">
           @if ($errors->any())
               <div class="alert alert-danger alert-dismissible fade show rounded-0 " style="font-weight: 400"
                   role="alert">
           ...
           @endif
           @if (session('success'))
               <div class="alert alert-success alert-dismissible fade show rounded-0 " style="font-weight: 400"
                   role="alert">
       ...
       <div class="col-lg-12">
           <button type="submit" class="btn btn-brand-1-big mr-25">
               ...
               <div wire:loading class="spinner-border spinner-border-sm ml-5" role="status">
   ...
   {{-- @script
       <script>
           ...
           $wire.on("quote-form:submit", function() {
