                        ...
                        <div class="swiper-container swiper-group-6 pb-0">
                            <div class="swiper-wrapper wow animate__animated animate__fadeIn">
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/alea.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/land.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/logis.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/truck.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/saltos.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                                <div class="swiper-slide"><img
                                        src="{{ Vite::asset('resources/static/imgs/slider/logo/creati.png') }}"
                                        alt="{{ config('app.name') }}">
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-30">
                    <div class="box-image-info-7"><img
                            src="{{ Vite::asset('resources/static/imgs/page/homepage4/img-info-7.png') }}"
                            alt="{{ config('app.name') }}">
    ...
    <section class="section mt-85">
        <div class="container">
            <div class="text-center"><img class="mb-15"
                    src="{{ Vite::asset('resources/static/imgs/template/icons/favicon.svg') }}"
                    alt="{{ config('app.name') }}">
                ...
                <div class="col-xl-7 col-lg-6 mb-30">
                    <div class="box-images-pround">
                        <div class="box-images wow animate__animated animate__fadeIn"><img class="img-main"
                                src="{{ Vite::asset('resources/static/imgs/page/homepage1/img1.png') }}"
                                alt="{{ config('app.name') }}">
                            <div class="image-2 shape-3"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/icon1.png') }}"
                                    alt="{{ config('app.name') }}">
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="cardLeadingCompany">
                        <div class="cardImage"><span class="img wow animate__animated animate__fadeIn"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/handover.png') }}"
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="cardLeadingCompany">
                        <div class="cardImage"><span class="img"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/cities.png') }}"
                                    alt="{{ config('app.name') }}"></span></div>
                        <div class="cardInfo">
                            <h3 class="color-brand-1 wow animate__animated animate__fadeIn"><span>+</span><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="cardLeadingCompany">
                        <div class="cardImage"><span class="img"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/client.png') }}"
                                    alt="{{ config('app.name') }}"></span></div>
                        <div class="cardInfo">
                            <h3 class="color-brand-1 wow animate__animated animate__fadeIn"><span>+</span><span
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-30">
                    <div class="cardLeadingCompany">
                        <div class="cardImage"><span class="img"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/company.png') }}"
                                    alt="{{ config('app.name') }}"></span></div>
                        <div class="cardInfo">
                            <h3 class="color-brand-1 wow animate__animated animate__fadeIn"><span>+</span><span
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="box-image-contact"><img
                                src="{{ Vite::asset('resources/static/imgs/page/homepage1/img-contact.png') }}"
                                    ...
                                    <div class="mb-30">
                                        <div class="card-testimonial-grid card-testimonial-3">
                                            <div class="box-author mb-25"><a href="index-3.html#"><img
                                                        src="{{ Vite::asset('resources/static/imgs/page/homepage1/author.png') }}"
                    ...
                    <div class="box-faqs-left">
                        ...
                        <div class="box-gallery-faqs">
                            <div class="image-top"><img
                                    src="{{ Vite::asset('resources/static/imgs/page/homepage1/img-faq1.png') }}"
                                    alt="{{ config('app.name') }}">
                            </div>
                            <div class="image-bottom">
                                <div class="image-faq-1"><img
                                        src="{{ Vite::asset('resources/static/imgs/page/homepage1/img-faq2.png') }}"
                                        alt="{{ config('app.name') }}"></div>
                                <div class="image-faq-2"><img
                                        src="{{ Vite::asset('resources/static/imgs/page/homepage1/img-faq3.png') }}"
                                        alt="{{ config('app.name') }}"></div>
                            </div>
                        </div>
                    </div>
